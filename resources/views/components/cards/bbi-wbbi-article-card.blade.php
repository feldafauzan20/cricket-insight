<div class="mx-2.25 border border-[#A9A9A9] md:mx-0 dark:border-[#353737]">
    {{-- Card Image --}}
    <img src="{{ asset('images/dummy/latest-news-card/dummy-latest-news-card.webp') }}" alt="Article Image"
    ...
    <div
        ...
        <div class="gap-x-4.25 mb-7.5 md:mb-8.5 flex items-center">
            <div class="flex w-20 flex-col items-center justify-center bg-[#A6A182]/10 px-2.5 py-5 dark:bg-white/10">
                <p class="font-barlow-semi-condensed mb-2 text-[22px] font-bold text-[#B90F16] dark:text-white">23</p>
                <p
                    class="font-figtree whitespace-nowrap text-xs font-bold leading-[135%] tracking-[-0.05em] text-[#AEB0B4]">
                    APRIL 2026</p>
            </div>
            <p
                class="font-barlow-semi-condensed md:w-63.5 text-xl font-bold uppercase leading-[130%] text-[#434343] md:block dark:text-white">
