<a href="#" class="h-61.75 md:h-85.25 group relative block overflow-hidden rounded-md">

    <img src="{{ asset('images/dummy/latest-news-card/dummy-latest-news-card.webp') }}" alt="title" width="1920"
    ...
    <div class="relative flex h-full flex-col justify-end px-3 pb-3">
        <div class="mb-1.5 flex h-fit w-full items-center justify-between">
            <div class="w-58.75">
                <h1 class="line-clamp-2 text-lg font-semibold text-white transition-colors group-hover:text-gray-200">
                    {{ Str::words('PCI has made history by successfully hosting the blablabalba', 8, '...') }}
                </h1>
            </div>
            <div
        ...
        <p class="mb-5.5 line-clamp-3 text-[10px] leading-[129.4%] tracking-[-3%] text-white/90">
            {{ Str::words('Lorem ipsum dolor sit amet consectetur adpiscing elit. Consectetur adipiscing elit quisque faucibus ex sapien vitae. sasaiugsiaubsiausgiaug', 20, '...') }}
        </p>
