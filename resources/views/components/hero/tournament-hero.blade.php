    ...
    $heroSlides = collect($articles)
        ->map(function ($article, $index) {
            ...
            return [
                ...
                'url' => !empty($article->slug)
                    ? route('news.show', ['locale' => app()->getLocale(), 'slug' => $article->slug])
                    : '#',
            ];
        })
        ->filter()
...
<section class="relative overflow-hidden">
        ...
        <div class="swiper-wrapper">
            @foreach ($heroSlides as $slide)
                <div class="swiper-slide relative">
                    {{-- Background Image --}}
                    <img src="{{ $slide['image'] }}" alt="Hero Image {{ $slide['id'] }}" width="1920"
                    ...
                    <div
                        ...
                        {{-- CTA BUTTON --}}
                        <div class="mb-2.5 w-fit rounded-[3px] bg-[#EC0226] px-6 py-2 md:mb-3.5 lg:mb-6">
                            <a href="{{ $slide['url'] }}" class="font-medium uppercase text-white">See More</a>
                        </div>
                        ...
                        <div class="text-white lg:flex lg:items-end">
                            <div class="w-57 flex items-center justify-between lg:h-fit">
                                <div class="h-9 w-9 overflow-hidden rounded-full">
                                    <img src="{{ $slide['author_image'] }}" alt="Profile Picture"
    ...
    <div
        class="2xl:top-68.75 z-20 hidden lg:absolute lg:right-10 lg:top-1/2 lg:flex lg:-translate-y-1/2 lg:flex-col lg:gap-y-2 2xl:right-10 xl:right-30">
        <x-buttons.next-button class="hero-carousel-button-next" />
        <x-buttons.previous-button class="hero-carousel-button-prev" />
    </div>

    {{-- Indicator Dots (Large screens) --}}
    <div class="lg:bottom-50 z-20 hidden lg:absolute lg:left-0 lg:right-0 lg:block xl:left-20">
    ...
    <div class="lg:pb-7.5 2xl:pb-10.5 z-20 hidden lg:absolute lg:bottom-0 lg:left-0 lg:right-0 lg:block xl:left-20 xl:right-20">
                    ...
                    <div
                        ...
                        <div class="flex gap-x-7 pt-7">
                            <div class="w-25 h-17.5 rounded-xs overflow-hidden">
                                <img src="{{ $slide['thumbnail'] }}" alt="News Card Image"
