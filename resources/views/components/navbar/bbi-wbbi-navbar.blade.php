<nav class="fixed left-0 top-0 z-50 w-full transition-colors duration-200" x-data="{ open: false, searchOpen: false, lang: 'ENG' }" x-init="$store.darkMode.init()">
        ...
        <div class="flex w-24 flex-col md:w-auto md:flex-1">
            ...
            <div
                ...
                <div class="flex items-center gap-x-2.5">
                    ...
                    {{-- Facebook --}}
                    <a href="https://www.facebook.com/people/Persatuan-Cricket-Indonesia/61560799396848"
                        target="__blank" class="rounded-full bg-white/10 p-2">
                    ...
                    {{-- Youtube --}}
                    <a href="https://youtube.com/@cricketindonesia8372" target="__blank"
            ...
            <div
                class="md:pr-3.75 flex flex-1 items-center justify-center bg-white md:justify-between md:py-2.5 md:pl-7">
                ...
                <div class="hidden 2xl:block">
                    <ul class="2xl:gap-11.75 flex">
                        <li><a href="#schedule"
                                class="font-figtree font-semibold tracking-[-0.05em] text-[#1F0222]">Watch
                                Live</a>
                        </li>
                        <li><a href="#highlighted-games"
                                class="font-figtree font-semibold tracking-[-0.05em] text-[#1F0222]">View
                                Fixtures</a>
                        </li>
                        <li><a href="#article"
                        ...
                        <li><a href="{{ route('home', ['locale' => app()->getLocale()]) }}"
                                class="font-figtree font-semibold tracking-[-0.05em] text-[#1F0222]">CRICKET
                                INSIGHT</a>
                        </li>
                    </ul>
                </div>
    ...
    @php
        $mobileMenu = [
            ...
            [
                'href' => '#highlighted-games',
                'active' => request()->is('#highlighted-games'),
                'label' => 'View
                                Fixtures',
            ],
            ['href' => '#article', 'active' => request()->is('#article'), 'label' => 'Article'],
            ['href' => '#top-stories', 'active' => request()->is('#top-stories'), 'label' => 'Top Stories'],
            [
                'href' => route('home', ['locale' => app()->getLocale()]),
                'active' => request()->is('/'),
                'label' => 'CRICKET INSIGHT',
            ],
        ];
    @endphp

    {{-- Mobile Drawer Overlay --}}
    <div x-show="open" x-transition.opacity x-cloak class="fixed inset-0 z-40 bg-black/60 2xl:hidden"
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-300"
        ...
        class="font-figtree fixed right-0 top-0 z-50 flex h-full w-full max-w-xs flex-col bg-[#1F2022] shadow-xl 2xl:hidden">
        ...
        <div class="flex items-center justify-between border-b border-white/10 px-6 py-5">
            ...
            <button @click="open = false"
                class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-[#97775B]">
                <x-iconoir-xmark class="h-5 w-5" />
            </button>
        </div>

        {{-- Menu items --}}
        <ul class="flex flex-1 flex-col gap-1 overflow-y-auto px-4 py-4 text-base font-semibold tracking-[-0.05em]">
            @foreach ($mobileMenu as $item)
                <li class="{{ $item['active'] ? 'border-[#97775B] bg-white/5' : 'border-transparent' }} border-l-4">
                    <a href="{{ $item['href'] }}"
                        class="{{ $item['active'] ? 'text-[#97775B]' : 'text-white' }} flex items-center px-4 py-3 transition hover:text-[#97775B]">
                        {{ $item['label'] }}
                    </a>
                </li>
            @endforeach
        ...
        {{-- Footer: subscribe + dark mode + contact + socials --}}
        <div class="border-t border-white/10 px-6 py-5">
            <a href="#"
                class="font-figtree mb-4 flex w-full items-center justify-center gap-1.5 bg-[#97775B] py-4 font-semibold text-white">
                Subscribe now!
            ...
            <div class="mb-4 flex items-center justify-between text-sm font-semibold text-white">
                ...
                <button @click="$store.darkMode.toggle()" class="relative h-6 w-11 rounded-full transition-colors"
                    :class="$store.darkMode.on ? 'bg-[#97775B]' : 'bg-white/20'">
            ...
            <a href="#" class="gap-x-2.25 mb-2 flex items-center text-sm text-white/80">
            ...
            <a href="#" class="gap-x-2.25 mb-4 flex items-center text-sm text-white/80">
                <svg width="20" height="20" viewBox="0 0 26 26" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M4.33073 21.6673C3.7349 21.6673 3.22501 21.4553 2.80106 21.0314C2.37712 20.6075 2.16478 20.0972 2.16406 19.5007V6.50065C2.16406 5.90482 2.3764 5.39493 2.80106 4.97098C3.22573 4.54704 3.73562 4.33471 4.33073 4.33398H21.6641C22.2599 4.33398 22.7701 4.54632 23.1948 4.97098C23.6195 5.39565 23.8314 5.90554 23.8307 6.50065V19.5007C23.8307 20.0965 23.6188 20.6067 23.1948 21.0314C22.7709 21.4561 22.2606 21.668 21.6641 21.6673H4.33073ZM12.9974 14.084L4.33073 8.66732V19.5007H21.6641V8.66732L12.9974 14.084ZM12.9974 11.9173L21.6641 6.50065H4.33073L12.9974 11.9173ZM4.33073 8.66732V6.50065V19.5007V8.66732Z"
            ...
            <div class="flex items-center gap-x-2.5">
                <a href="https://x.com/Cricket_INA" target="__blank" class="rounded-full bg-white/10 p-2.5">
                    <svg width="13" height="13" viewBox="0 0 15 15" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_mob_1531)">
                            <path
                                d="M11.8125 0.703125H14.1129L9.08786 6.46098L15 14.2974H10.3714L6.74357 9.54562L2.59714 14.2974H0.294643L5.66893 8.1367L0 0.704196H4.74643L8.02071 5.0467L11.8125 0.703125ZM11.0036 12.9174H12.2786L4.05 2.01134H2.68286L11.0036 12.9174Z"
                                fill="white" />
                        </g>
                        <defs>
                            <clipPath id="clip0_mob_1531">
                                <rect width="15" height="15" fill="white" />
                            </clipPath>
                        </defs>
                    </svg>
                </a>
                <a href="https://www.facebook.com/people/Persatuan-Cricket-Indonesia/61560799396848" target="__blank"
                    class="rounded-full bg-white/10 p-2">
                ...
                <a href="https://youtube.com/@cricketindonesia8372" target="__blank"
                    ...
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 5C21 5 21 5 21 12C21 19 21 19 12 19C3 19 3 19 3 12C3 5 3 5 12 5Z" stroke="white"
