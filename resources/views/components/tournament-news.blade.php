<div class="md:px-7.5 md:pt-12.5 px-6 pb-4 pt-6 2xl:container md:pb-6 lg:px-10 lg:pb-11 2xl:mx-auto 2xl:px-0 2xl:pb-6">
    <div class="items-center justify-between md:flex">
        <div>
            <h1 class="text-2xl font-semibold text-[#121212] md:text-[22px] dark:text-white">Latest News Around Cricket
                Insight</h1>
...
<div
    ...
    <div class="2xl:w-1/2 2xl:min-w-0">
        <div class="mb-3.75 md:flex md:items-center md:gap-x-5">
            <h1 class="whitespace-nowrap text-[22px] font-semibold text-[#121212]">Indonesia Tournament News
            </h1>
        ...
        <div class="gap-y-3.75 flex flex-col">
            @for ($i = 0; $i < 9; $i++)
                <div class="rounded-b-[5px] border-b border-[#EFEFEF] md:flex md:border dark:border-[#DEDEDE]">
                    ...
                    <div
                        class="md:pl-4.5 lg:w-110.25 border-x border-[#F3F3F3] p-4 md:border-0 md:p-0 md:py-7 2xl:w-full">
    ...
    <div class="2xl:w-1/2 2xl:min-w-0">
        <div class="mb-3.75 mt-7.5 md:flex md:items-center md:gap-x-5 2xl:mt-0">
            <h1 class="text-[22px] font-semibold text-[#121212] md:whitespace-nowrap">International Tournament News
            </h1>
